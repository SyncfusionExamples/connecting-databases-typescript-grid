## TypeScript Grid SQLite database connectivity using URLAdaptor

A project that enables data binding and CRUD action handling in the Syncfusion TypeScript Grid to a SQLite database using URLAdaptor feature of the Grid.
