## TypeScript Grid SQLite database connectivity using CustomAdaptor

A project that enables data binding and CRUD action handling in the Syncfusion TypeScript Grid to a SQLite database using CustomAdaptor feature of the Grid.
