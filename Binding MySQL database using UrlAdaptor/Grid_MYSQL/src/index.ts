...
let data: DataManager = new DataManager({
    url: 'https://localhost:7159/api/Grid',
    insertUrl: 'https://localhost:7159/api/Grid/Insert',
    updateUrl: 'https://localhost:7159/api/Grid/Update',
    removeUrl: 'https://localhost:7159/api/Grid/Remove',
    batchUrl: 'https://localhost:7159/api/Grid/BatchUpdate',
