## TypeScript Grid MYSQL connectivity using URLAdaptor

A project that enables data binding and CRUD action handling in the Syncfusion TypeScript Grid to a MYSQL Server using URLAdaptor feature of the Grid.
